...
from PySide6.QtGui import QColor, QPen, QBrush, QFont, QPixmap, QPainter, QPainterPath
...
class TimelineGraphWidget(QGraphicsView):
    ...
    def refresh(self):
        ...
        # Mapping for date/row positions
        ...
        # Draw horizontal timeline for each place
        for pname, y in place_y.items():
            # Timeline line (thicker and colored)
        ...
        # Draw vertical lines for dates and date labels on the axis
        ...
        for ev in events:
            ...
            for place in getattr(ev, 'places', []):
                ...
                # Draw a line from event to timeline
